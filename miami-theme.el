...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   `(spacemacs-normal-face ((,class (:background ,str :box nil))))
   `(spacemacs-insert-face ((,class (:background ,func :box nil))))
   `(spacemacs-visual-face ((,class (:background ,keyword))))
   `(spacemacs-motion-face ((,class (:background ,str))))

   `(mode-line ((,class (:box nil :foreground ,keyword :background ,bg2))))
