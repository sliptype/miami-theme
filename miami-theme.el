...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   `(fringe ((,class nil)))
   `(powerline-active1 ((,class (:background ,bg1, :box nil))))
   `(powerline-active2 ((,class (:background ,bg1 :box nil))))
   `(powerline-inactive2 ((,class (:background ,bg1))))
   `(spacemacs-normal-face ((,class (:background ,str :foreground ,bg1 :box nil))))
   `(spacemacs-insert-face ((,class (:background ,func :foreground ,bg1 :box nil))))
   `(spacemacs-visual-face ((,class (:background ,keyword :foreground ,bg1))))
   `(spacemacs-motion-face ((,class (:background ,str :foreground ,bg1))))

   `(mode-line ((,class (:box nil :background ,bg5 :foreground ,keyword))))
   `(mode-line-inactive ((,class (:foreground ,key3 :background ,bg1 :weight normal))))
   `(mode-line-buffer-id ((,class (:foreground ,str :background nil))))
   ...
   `(helm-separator ((,class (:foreground ,fg1 :background ,bg1))))
   `(helm-time-zone-current ((,class (:foreground ,fg1 :background ,bg1))))
   `(helm-time-zone-home ((,class (:foreground ,fg1 :background ,bg1))))
   `(helm-buffer-not-saved ((,class (:foreground ,fg1 :background ,bg1))))
   `(helm-buffer-process ((,class (:foreground ,fg1 :background ,bg1))))
   ...
   `(company-preview-search ((,class (:foreground ,fg1 :background ,bg1))))
